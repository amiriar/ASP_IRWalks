...
{
    /// <inheritdoc />
    public partial class seeds_added : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1950e3bd-fa76-45a3-8b3b-a50793576bf3"), "Extra Hard" },
                    { new Guid("57536d2b-6563-40fd-b36b-b433e8565cac"), "Medium" },
                    { new Guid("ae505fb0-9e9f-4c2f-bef6-c0f3a0ecd128"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("1950e3bd-fa76-45a3-8b3b-a50793576bf3"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("57536d2b-6563-40fd-b36b-b433e8565cac"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("ae505fb0-9e9f-4c2f-bef6-c0f3a0ecd128"));
